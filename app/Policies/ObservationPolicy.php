...
class ObservationPolicy
{
    ...
    {
        return $user->can('create observation');
    }
    ...
    {
        return $user->can('update observation');
    }
    ...
    {
        return $user->can('delete observation');
    }
    ...
    {
        return $user->can('restore observation');
    }
    ...
    {
        return $user->can('destroy observation');
    }
}
